...
ENTRIES = [
    {"id": 1, "title": "There's value in stepping back.", "creation_date": "December 14, 2016", "body": """Sometimes principles from our past help with our present. Before starting the double linked list today, I committed to two things:
...
SUCH IS LIFE."""},
    {"id": 2, "title": "Revenge is Best SERVERED Cold", "creation_date": "December 15, 2016", "body": """The second you feel like youre starting to climb youre way out of the avalanche of work and information theres always some weird and random server error to pull you right back in.  Im struggling a lot to find ways to refactor and clean up the server code. I feel like were working with a patchwork of try/except statements, teetering towers of if/else logic, and precarious while loops.
Id like to see an example of a server done RIGHT. But I want to earn that - I want to finish my own server the hard way.Hey, urllib2, sup?"""},
    ...
    {"id": 5, "title": "Tunnels, Lights, Progress, etc.", "creation_date": "December 20th, 2016", "body": """Two quick things, the binary heap was initially a pain in the ass.  However, I feel really proud of the implementation I have.  Hooray for max OR min.
